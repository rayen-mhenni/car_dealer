            ...
            <div className="col-md-12 text-center">
              ...
              <div className="page-active">
                <ul>
                  ...
                  <li>
                    <a href="listin-right.html">Vehicle details</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="flexslider">
                <ul className="slides">
                  <li data-thumb="http://dummyimage.com/117x83/cccccc/fff.jpg">
                    <img
                      src="http://dummyimage.com/770x350/cccccc/fff.jpg"
                      alt=""
                    />
                  </li>
                  <li data-thumb="http://dummyimage.com/117x83/cccccc/fff.jpg">
              ...
              <div className="tab">
                <div className="tabs">
                  <ul className="tab-links">
                    <li>
                      <a href="#tab1">vehicle overview</a>
                    </li>
                    <li className="active">
                      <a href="#tab2">description</a>
                    </li>
                    <li>
                      <a href="#tab3">vehicle location</a>
                    </li>
                    <li>
                      <a href="#tab4">contact dealer</a>
                    </li>
                  </ul>
                  <div className="tab-content">
                    <div id="tab1" className="tab">
                      <p>
                        ...
                        elit. Excepturi in dolorem blanditiis voluptatibus
                        quidem nisi eaque, cupiditate minus omnis, voluptatum
                        corporis neque placeat quod temporibus mollitia. Quod
                        accusamus iure eveniet laboriosam laudantium, saepe
                        quidem incidunt, laboriosam aliquid quibusdam atque.
                      </p>
                    </div>
                    <div id="tab2" className="tab active">
                      ...
                      <p>
                        ...
                        <br />
                        <br />
                        Migas gluten-free ennui Truffaut ugh, listicle umami
                        plaid lomo sustainable mumblecore street art biodiesel
                        ...
                        cronut beard migas ethical. Seitan wolf Vice banh mi
                        YOLO flannel. Banh mi pug cred church-key, cardigan
                        drinking vinegar hella bicycle rights ugh sustainable.
                        Marfa Bushwick aesthetic, locavore messenger bag 8-bit
                        tote bag.
                      </p>
                    </div>
                    <div id="tab3" className="tab">
                      <p>
                        ...
                        quidem nisi eaque, cupiditate minus omnis, voluptatum
                        corporis neque placeat quod temporibus mollitia. Quod
                        accusamus iure eveniet laboriosam laudantium.
                      </p>
                    </div>
